...
//}
//
//internal fun Fragment.repeatOnLifecycleStarted(block: suspend CoroutineScope.() -> Unit) {
...
//}
//
//internal fun Fragment.repeatOnLifecycleResumed(block: suspend CoroutineScope.() -> Unit) {
//    viewLifecycleOwner.lifecycleScope.launch {
